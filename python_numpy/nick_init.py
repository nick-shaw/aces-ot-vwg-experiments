...
def print_constants():
  ...
  np.save("gamutCuspTable", gamutCuspTable)
  np.save("gamutCuspTableReach", gamutCuspTableReach)
  np.save("cgamutCuspTable", cgamutCuspTable)
  np.save("cgamutReachTable", cgamutReachTable)
  np.save("gamutTopGamma", gamutTopGamma)
